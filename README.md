# The-Mint-to-Logic-Universe-private-vault
The Mint-to Logic universe private vault is to store threads that were used to articualte MInt-Units and physical domians etc.
